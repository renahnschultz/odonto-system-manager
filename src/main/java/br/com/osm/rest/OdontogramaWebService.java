...
@Path("odontograma")
public class OdontogramaWebService extends OSMServiceBase<Long, Odontograma> {
	...
	@Inject
	public OdontogramaWebService(OdontogramaDAO entidadeDAO) {
		super(entidadeDAO);
	}

	@Override
	protected void validacaoSalvar(Odontograma entidade) throws OSMException {
		try {
		}catch(Exception e) {
			e.printStackTrace();
	...
	public Response salvar(Odontograma entidade) {
