...
@Path("auditoria")
public class AuditoriaWebService extends OSMServiceBase<Long, Auditoria> {
	...
	@Inject
	public AuditoriaWebService(AuditoriaDAO entidadeDAO) {
		super(entidadeDAO);
	}

	@Override
	protected void validacaoSalvar(Auditoria entidade) throws OSMException {
		try {
		} catch (Exception e) {
			e.printStackTrace();
	...
	public Response salvar(Auditoria entidade) {
