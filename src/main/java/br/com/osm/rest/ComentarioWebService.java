...
@Path("comentario")
public class ComentarioWebService extends OSMServiceBase<Long, Comentario> {
	...
	@Inject
	public ComentarioWebService(ComentarioDAO entidadeDAO) {
		super(entidadeDAO);
	}

	@Override
	protected void validacaoSalvar(Comentario entidade) throws OSMException {
		try {
		}catch(Exception e) {
			e.printStackTrace();
