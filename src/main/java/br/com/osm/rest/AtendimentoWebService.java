...
@Path("atendimento")
public class AtendimentoWebService extends OSMServiceBase<Long, Atendimento> {
	...
	@Inject
	public AtendimentoWebService(AtendimentoDAO entidadeDAO) {
		super(entidadeDAO);
	}

	@Override
	protected void validacaoSalvar(Atendimento entidade) throws OSMException {
		try {
		}catch(Exception e) {
			e.printStackTrace();
	...
	public Response salvar(Atendimento entidade) {
